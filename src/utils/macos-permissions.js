...
function classifyMacAutomationError(value) {
  ...
  if (/not authorized to send apple events|assistive access|assistive devices|yardımcı erişime izin verilmiyor|accessibility|mouse.*tanımlanmamış|değişkeni tanımlanmamış.*mouse|(-1719)|(-1743)|(-2753)/i.test(text)) {
    return {
