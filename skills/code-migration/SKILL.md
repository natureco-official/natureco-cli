---
name: code-migration
description: Plan and execute code migrations across languages, frameworks, or architectures
...
## Overview
Plan and execute code migrations across languages, frameworks, or architectures. This skill helps you apply structured, repeatable methods for consistent results.

## When to Use
- When you need to apply code migration best practices
- When establishing processes or standards for your workflow
- When training team members on code migration
- When automating or optimizing code migration tasks
...
## Examples
```
User: Help me apply code migration for my current project
Assistant: I'll help you apply code migration step by step...
```
