...
description: Transform JSON data with jq, JSONPath, mapping, and schema validation
...
## Overview
Transform JSON data with jq, JSONPath, mapping, and schema validation. This skill helps you apply structured, repeatable methods for consistent results.

## When to Use
- When you need to apply json transformation best practices
- When establishing processes or standards for your workflow
- When training team members on json transformation
- When automating or optimizing json transformation tasks
...
## Examples
```
User: Help me apply json transformation for my current project
Assistant: I'll help you apply json transformation step by step...
```
