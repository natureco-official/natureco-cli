---
name: web-scraping
description: Scrape websites with selectors, pagination, rate limiting, and anti-bot avoidance
...
## Overview
Scrape websites with selectors, pagination, rate limiting, and anti-bot avoidance. This skill helps you apply structured, repeatable methods for consistent results.

## When to Use
- When you need to apply web scraping best practices
- When establishing processes or standards for your workflow
- When training team members on web scraping
- When automating or optimizing web scraping tasks
...
## Examples
```
User: Help me apply web scraping for my current project
Assistant: I'll help you apply web scraping step by step...
```
