...
description: Process images with resizing, format conversion, filters, and OCR
...
## Overview
Process images with resizing, format conversion, filters, and OCR. This skill helps you apply structured, repeatable methods for consistent results.

## When to Use
- When you need to apply image processing best practices
- When establishing processes or standards for your workflow
- When training team members on image processing
- When automating or optimizing image processing tasks
...
## Examples
```
User: Help me apply image processing for my current project
Assistant: I'll help you apply image processing step by step...
```
