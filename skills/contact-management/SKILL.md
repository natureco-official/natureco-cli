...
description: Manage contacts with deduplication, categorization, and export tools
...
## Overview
Manage contacts with deduplication, categorization, and export tools. This skill helps you apply structured, repeatable methods for consistent results.

## When to Use
- When you need to apply contact management best practices
- When establishing processes or standards for your workflow
- When training team members on contact management
- When automating or optimizing contact management tasks
...
## Examples
```
User: Help me apply contact management for my current project
Assistant: I'll help you apply contact management step by step...
```
